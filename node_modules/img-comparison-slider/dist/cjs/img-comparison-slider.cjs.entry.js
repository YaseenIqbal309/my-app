...
const index = require('./index-65e47284.js');
...
const ImgComparisonSlider = class {
  ...
  render() {
    return (index.h("div", null, index.h("div", { class: "before", ref: (el) => (this.before = el) }, index.h("slot", { name: "before" })), index.h("div", { class: "after", ref: (el) => (this.after = el) }, index.h("div", { class: "handle-wrapper" }, index.h("slot", { name: "handle" }, index.h("div", { class: "handle" }))), index.h("div", { class: "after-overlay" }, index.h("div", { ref: (el) => (this.afterImageContainer = el) }, index.h("slot", { name: "after" }))))));
  }
